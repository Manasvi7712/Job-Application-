...
## Known limitation
WebSearch results are not guaranteed to be posted within exactly 24 hours — search engines index on their own schedule. Treat WebSearch hits as "recent, worth checking" and treat the platform-native filtered links (Step 1) as the ground truth for true last-24-hours freshness.
